    ...
    <div className="page-enter">
      ...
      <div className="p-6">
        <div className="bg-white rounded-xl border border-slate-200 p-12 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="text-slate-800 font-bold text-xl mb-2">Gestão de Pedidos</h2>
          <p className="text-slate-400 text-sm max-w-sm">
            Em breve: listagem completa de pedidos com filtros, busca,
            timeline e gestão de artes.
          </p>
        </div>
      </div>
    </div>
